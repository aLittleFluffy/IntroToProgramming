...
/* SELF ASSESSMENT
   1.  createSequence:
	Did I use the correct method definition?
		Mark out of 5: 5
		Comment: Method takes integer input and returns int array
	Did I create an array of size n (passed as the parameter) and initialise it?
		Mark out of 5: 5
		Comment: The array starts at 2 and goes up to N
	Did I return the correct item?
		Mark out of 5: 5
		Comment: Return is int array
   2.  crossOutMultiples
	Did I use the correct method definition?
		Mark out of 5: 5
		Comment: Takes int[] and int as parameters and returns new int[]
	Did I ensure the parameters are not null and one of them is a valid index into the array
		Mark out of 2: 2
		Comment: Checks for array length and that array is valid
	Did I loop through the array using the correct multiple?
		Mark out of 5: 5
		Comment: Loop through array to determine if multiples are present
	Did I cross out correct items in the array that were not already crossed out?
		Mark out of 3: 3
		Comment: Check that elements are not already crossed out.
   3.  sieve
	Did I have the correct function definition?
		Mark out of 5: 5
		Comment: Takes int N and returns int[] with non primes crossed out
   ...
   4.  sequenceTostring
	...
	Did I ensure the parameter to be used is not null?
		Mark out of 3:3
		Comment: Checked that input array has length >0
	Did I Loop through the array updating the String variable with the non-crossed out numbers and the crossed numbers in brackets?
		Mark out of 10: 10
		Comment: basic if statement used to format output for each character.
   5.  nonCrossedOutSubseqToString
	Did I have the correct function definition
		Mark out of 5: 5
		Comment: Takes int[] returns string of array.
	Did I ensure the parameter to be used is not null?
		Mark out of 3: 3
		Comment: Checked that array exists
	Did I loop through the array updating the String variable with just the non-crossed out numbers?
		Mark out of 5: 5
		Comment: basic if statement used, similar to previous except we don't care about what happens to negatives.
   6.  main
	Did I ask  the user for input n and handles input errors?
		Mark out of 5: 5
		Comments: getInt() method handles input.
